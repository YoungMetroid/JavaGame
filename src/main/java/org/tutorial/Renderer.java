...
public class Renderer {
    ...
    public static void render(Tile tile){
        int yTileLocation = (int)(tile.getSpriteYLocation());
        int y = (int)(tile.getYLocation() + Camara.y);
        int x = (int)(tile.getXLocation() + Camara.x);

        int yy = WIDTH*y;

        for(int i = WIDTH*y; i < (WIDTH*y) + tile.getTileSize();i++){
            int xTileLocation = (int)(tile.getSpriteXLocation());
